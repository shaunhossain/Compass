...
public class FirstAnimation extends AwesomeSplash {
    ...
    public void animationsFinished() {
        Toast.makeText(FirstAnimation.this, "Wellcome to Compass", Toast.LENGTH_SHORT).show();
        startActivities(new Intent[]{new Intent(FirstAnimation.this, MainActivity.class)});
    }
}